        ...
        characters = characterList.map((character) => (
            <div key={character.id} className="character-card">
                <div className="character-card__image">
                    <img onClick={() => loadDetails(character.id)} src={character.image} alt={character.name} />
                </div>

                <div className="character-card__description">
                    <div className="description-titles">
                        <h2 onClick={() => loadDetails(character.id)} className="description-titles__title">{character.name}</h2>
